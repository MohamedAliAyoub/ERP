...
class ManageTeamsController extends AdminBaseController
{
    ...
    {
        $users = User::get();
        return view('admin.teams.create', $this->data )->with('users' , $users);
    }
    ...
    public function store(StoreTeam $request)
    {
        ...
        $group->manger_id = $request->manger_id;
        $group->save();
    ...
    public function edit($id)
    {
        ...
        $users = User::get();
        return view('admin.teams.edit', $this->data)->with('users' , $users);
    }
    ...
    public function quickCreate()
    {
        $users = User::get();
        $this->teams = Team::all();
        return view('admin.teams.quick-create', $this->data)->with('users' , $users);
    }
