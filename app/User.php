...
class User extends BaseModel implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    {
        return $this->hasOne(Team::class , 'manger_id');
    }
    public function checkManger()
    {
        $mangers = Team::get('manger_id')->pluck('manger_id');
        if( $mangers->search(auth()->id())  )
            return true;
        return false;
    }
    ...
    {
        return $this->hasOneThrough(Team::class, EmployeeDetails::class, 'user_id', 'id', 'id', 'department_id');
    }
