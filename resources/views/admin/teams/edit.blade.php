                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label">@lang('app.manger')</label>
                                    <select class="form-control" name="manger_id" id="manger_id">
                                        @if($users)
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}" @if(  $group->manger_id==$user->id) selected @endif >{{ $user->name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
