<div id="event-detail">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('app.menu.leaves') @lang('app.accept') @lang('app.accept')</h4>
    </div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="form-group">
                        <label>@lang('app.accept') @lang('app.reason')? (@lang('app.optional'))</label>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger save-event waves-effect waves-light"> @lang('app.accept')
        </button>
    </div>
